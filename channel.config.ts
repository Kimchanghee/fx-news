...
export const channel = {
  ...
  domain: 'forexcommoditynews.online',
  accent: 'green',
  ...
  rssSources: [
    ...
    { url: 'https://www.investing.com/rss/commodities_Metals.rss', category: 'market' },
    { url: 'https://www.fxstreet.com/rss/news', category: 'breaking' }
  ] as RSSSource[],
  categories: [
